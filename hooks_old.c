...
void installHooks()
{
	...
	hook2 = taiHookFunctionOffsetForKernel(KERNEL_PID, &threadInfoRef, tai_info.modid, 0, 0x205C, 1, threadInfoPatched);
	hook5 = taiHookFunctionOffsetForKernel(KERNEL_PID, &threadRegRef, tai_info.modid, 0, 0x2F40, 1, threadRegPatched);
	hook6 = taiHookFunctionOffsetForKernel(KERNEL_PID, &moduleInfoRef, tai_info.modid, 0, 0xAE28, 1, moduleInfoPatched);
	hook11 = taiHookFunctionOffsetForKernel(KERNEL_PID, &stackInfoRef, tai_info.modid, 0, 0x229C, 1, stackInfoPatched);
	...
	hook8 = taiInjectDataForKernel(KERNEL_PID, tai_info.modid, 0, 0x111BA, &nop_nop, 2);
	hook9 = taiInjectDataForKernel(KERNEL_PID, tai_info.modid, 0, 0x1024C, &nop_nop, 2);
